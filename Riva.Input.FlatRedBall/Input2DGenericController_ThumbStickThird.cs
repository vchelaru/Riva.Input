...
{
    public class Input2DGenericController_ThumbStickThird : Input2DGenericController_ThumbStickBase
    {
        ...
        public Input2DGenericController_ThumbStickThird(DirectInputGamepad parentDevice) : base(parentDevice) {}
